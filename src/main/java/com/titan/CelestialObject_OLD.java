...
public class CelestialObject_OLD {
     ...
     * @param radius
     */
    public CelestialObject_OLD(String name, double m, Vector3d initialPos, Vector3d initialVel, double diameter, Color color, int radius) {
        ...
        this.position = new Vector(new double[]{initialPos.getX1(), initialPos.getX2(), initialPos.getX3()});
        this.velocity = new Vector(new double[]{initialVel.getX1(), initialVel.getX2(), initialVel.getX3()});
    }


    public CelestialObject_OLD(String name, double m, Vector3d initialPos, Vector3d initialVel, long diameter, Color color) {
    ...
    public void updateCurrentPosition(Vector3d position) {
        ...
        this.position = new Vector(new double[]{position.getX1(), position.getX2(), position.getX3()});
    ...
    public void updateVelocity(Vector3d velocity) {
        ...
        this.velocity = new Vector(new double[]{velocity.getX1(), velocity.getX2(), velocity.getX3()});
        if (Titan.currentStep % (86400 / Titan.stepSize) == 0) {
