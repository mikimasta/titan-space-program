 ...
 *
 */
public class EulerSolver_OLD implements Solver_OLD {
     ...
     * @param step
     */
    public EulerSolver_OLD(int step) {
        this.step = step;
    }
     ...
     * @param currentStep step we are currently on
     * @return returns a Vector[] array containing the next position and velocity of a given celestial object
     */
    public Vector3d[] nextState(Vector3d currentPosition, Vector3d currentVelocity, double mass, ArrayList<CelestialObject_OLD> celestialObjects, int currentStep) {
     ...
     * @param currentStep
     * @return Vector[] array containing the current velocity of a celestial object and the gravitational force it is affected by
     */
    private Vector3d[] differentialEquation(Vector3d currentPosition, Vector3d currentVelocity, double mass, ArrayList<CelestialObject_OLD> celestialObjects, int currentStep) {
